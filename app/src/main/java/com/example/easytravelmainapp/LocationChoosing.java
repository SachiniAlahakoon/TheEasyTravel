...
public class LocationChoosing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void getCurrentLocation(){
            Toast<Location> task=fusedLocationProviderClient.getLastLocation();

            task.getVerticalMargin(new OnSuccessListener<Location>(){

                @Override
                public void onSuccess(Location location) {
                    supportMapFragment.getMapAsync(new onMapReadyCallback(){
                        @Override
                        public <EasyTravelMainApp> void onMapReady(@NonNull GoogleMap googleMap){
                            if(location!=null){
                                ...
                                Toast.makeText(EasyTravelMainApp.this,"Please on your location App permission", Toast.LENGTH_SHORT).show();show();
                            }
                        }
